...
if ($ApplyAggressiveV2) {
    ...
    $env:FUTURES_PROFIT_LOCK_ALLOWED_LANES = "BTC_USDT:COIL_BREAKOUT_LONG,SOL_USDT:IMPULSE_EVENT_CONTINUATION_LONG,SOL_USDT:IMPULSE_EVENT_CONTINUATION_SHORT,*:SHARP_EVENT_BREAKOUT_LONG,*:SHARP_EVENT_BREAKOUT_SHORT"
