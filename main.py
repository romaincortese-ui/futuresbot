...
os.environ.setdefault("FUTURES_PMT_PROFIT_LOCK_TRIGGER_PCT", "4.0")
os.environ.setdefault("FUTURES_PMT_PROFIT_LOCK_GIVEBACK_PCT", "0.0")
os.environ.setdefault("FUTURES_PMT_PROFIT_LOCK_PULLBACK_FRACTION", "0.35")
os.environ.setdefault("FUTURES_PMT_PROFIT_LOCK_MIN_TP_PROGRESS", "0.0")
os.environ.setdefault("FUTURES_PMT_PROFIT_LOCK_FLOOR_PCT", "3.0")
