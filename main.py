...
os.environ.setdefault("FUTURES_PMT_CYCLE_SECONDS", "45")
os.environ.setdefault("FUTURES_LATENCY_TRACE_ENABLED", "1")
os.environ.setdefault("FUTURES_PMT_MIN_SCORE", "90")
os.environ.setdefault("FUTURES_PMT_SIMPLE_SCORING_ENABLED", "1")
os.environ.setdefault("FUTURES_PMT_SIMPLE_CORE_WEIGHT", "0.90")
os.environ.setdefault("FUTURES_PMT_DYNAMIC_CORE_WEIGHT_ENABLED", "1")
os.environ.setdefault("FUTURES_PMT_SIMPLE_CORE_WEIGHT_REDIS_KEY", "mexc:pmt_simple_core_weight")
os.environ.setdefault("FUTURES_PMT_SIMPLE_CORE_WEIGHT_REFRESH_SECONDS", "300")
os.environ.setdefault("FUTURES_PMT_SIMPLE_CORE_WEIGHT_STALE_SECONDS", "32400")
os.environ.setdefault("FUTURES_PMT_SIMPLE_CORE_WEIGHT_TTL_SECONDS", "32400")
os.environ.setdefault("FUTURES_PMT_SIMPLE_CORE_WEIGHT_GRID", "0.95,0.90,0.85,0.80,0.75")
os.environ.setdefault("FUTURES_PMT_CONFIRMATION_BARS", "0")
os.environ.setdefault("FUTURES_PMT_CONFIRMATION_MIN_FOLLOWTHROUGH_PCT", "0")
os.environ.setdefault("FUTURES_PMT_FUNDING_HARD_BLOCK_ENABLED", "0")
os.environ.setdefault("FUTURES_PMT_FUNDING_SCORE_ENABLED", "1")
os.environ.setdefault("FUTURES_PMT_FUNDING_ADVERSE_EXCESS_PENALTY_PER_CAP", "1.0")
os.environ.setdefault("FUTURES_PMT_FUNDING_ADVERSE_MAX_PENALTY", "2.0")
os.environ.setdefault("FUTURES_PMT_FUNDING_ADVERSE_REDUCED_SIZE_CAP_ENABLED", "1")
os.environ.setdefault("FUTURES_PMT_FUNDING_ADVERSE_SCORE_CAP", "91.99")
os.environ.setdefault("FUTURES_PMT_FUNDING_FAVORABLE_MAX_BONUS", "0.5")
os.environ.setdefault("FUTURES_PMT_SIMPLE_HIGH_SCORE_BLOWOFF_VOLUME_RATIO", "2.0")
os.environ.setdefault("FUTURES_PMT_SIMPLE_HIGH_SCORE_BLOWOFF_1BAR_PCT", "0.018")
os.environ.setdefault("FUTURES_PMT_SIMPLE_HIGH_SCORE_BLOWOFF_1H_PCT", "0.018")
os.environ.setdefault("FUTURES_PMT_SIMPLE_HIGH_SCORE_BLOWOFF_SCORE_CAP", "89")
os.environ.setdefault("FUTURES_PMT_SIMPLE_HIGH_SCORE_BROADER_OVERSTRETCH_24H_PCT", "0.080")
os.environ.setdefault("FUTURES_PMT_SIMPLE_HIGH_SCORE_BROADER_OVERSTRETCH_MAX_1H_PCT", "0.025")
os.environ.setdefault("FUTURES_PMT_SIMPLE_HIGH_SCORE_BROADER_OVERSTRETCH_SCORE_CAP", "89")
os.environ.setdefault("FUTURES_PMT_MIN_SCORE", "92.5")
os.environ.setdefault("FUTURES_PMT_REDUCED_SCORE_ENTRIES_ENABLED", "1")
os.environ.setdefault("FUTURES_PMT_REDUCED_ENTRY_MIN_SCORE", "92.5")
os.environ.setdefault("FUTURES_PMT_REDUCED_ENTRY_LABEL_PREFIXES", "FLASH_,MEGA_")
os.environ.setdefault("FUTURES_PMT_FULL_BALANCE_MIN_SCORE", "95")
os.environ.setdefault("FUTURES_PMT_SCORE_BAND_SIZING_ENABLED", "1")
os.environ.setdefault("FUTURES_PMT_SCORE_BAND_SIZE_90_91", "0.25")
os.environ.setdefault("FUTURES_PMT_SCORE_BAND_SIZE_92_94", "0.50")
os.environ.setdefault("FUTURES_PMT_SCORE_BAND_SIZE_95_100", "1.0")
os.environ.setdefault("FUTURES_PMT_STOP_CHASE_COOLDOWN_HOURS", "6")
os.environ.setdefault("FUTURES_PMT_STOP_CHASE_EXIT_REASONS", "STOP_LOSS,PEAK_PROTECTION_GAP_EXIT")
os.environ.setdefault("FUTURES_PMT_QUICK_PROFIT_PROTECTION_ENABLED", "0")
os.environ.setdefault("FUTURES_PMT_MIN_LEVERAGE", "15")
os.environ.setdefault("FUTURES_PMT_MAX_LEVERAGE", "25")
os.environ.setdefault("FUTURES_PMT_STOP_FIRST_SIZING_ENABLED", "1")
os.environ.setdefault("FUTURES_PMT_STOP_FIRST_ATR_PERIOD", "14")
os.environ.setdefault("FUTURES_PMT_STOP_FIRST_ATR_MULT", "3.0")
os.environ.setdefault("FUTURES_PMT_STOP_FIRST_RISK_BUDGET_MARGIN_PCT", "20.0")
os.environ.setdefault("FUTURES_PMT_STOP_FIRST_TARGET_R", "5.0")
os.environ.setdefault("FUTURES_PMT_STOP_FIRST_MIN_LEVERAGE", "1")
os.environ.setdefault("MEXC_PERP_DEFAULT_TAKER_FEE_RATE", "0.0008")
os.environ.setdefault("FUTURES_PMT_PROFIT_LOCK_TRIGGER_PCT", "5.5")
os.environ.setdefault("FUTURES_PMT_PROFIT_LOCK_GIVEBACK_PCT", "0.0")
os.environ.setdefault("FUTURES_PMT_PROFIT_LOCK_PULLBACK_FRACTION", "0.15")
os.environ.setdefault("FUTURES_PMT_PROFIT_LOCK_MIN_TP_PROGRESS", "0.0")
os.environ.setdefault("FUTURES_PMT_PROFIT_LOCK_FLOOR_PCT", "5.0")
os.environ.setdefault("FUTURES_PMT_PROFIT_LOCK_EXIT_MIN_NET_PCT", "0.0")
os.environ.setdefault("FUTURES_PMT_EXCHANGE_PROFIT_LOCK_ENABLED", "1")
os.environ.setdefault("FUTURES_PMT_EXCHANGE_PROFIT_LOCK_MIN_STEP_TICKS", "1")
os.environ.setdefault("FUTURES_PMT_EXCHANGE_PROFIT_LOCK_ERROR_RETRY_SECONDS", "30")
os.environ.setdefault("FUTURES_PMT_TP_COOLDOWN_HOURS", "0")
